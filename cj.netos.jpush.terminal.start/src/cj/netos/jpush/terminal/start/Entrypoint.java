package cj.netos.jpush.terminal.start;
...
public class Entrypoint {
	...
	public static void main(String[] args) throws ParseException, IOException {
		fileName = "cj.netos.jpush.terminal.node";
		...
		if (line.hasOption("m")) {
			...
			formatter.printHelp("terminal node", options);
			return;
		}
		...
		assembly.start();
		Object node = assembly.workbin().part("terminalNode");
