...
public class JPushCircuit implements IPrinter, IDisposable {
    private Map<String, String> headmap;
    private Map<String, Object> attributemap;
    protected transient ICircuitContent content;
    static transient final String CODE = "utf-8";

    public JPushCircuit(String frame_line) {
        this(frame_line, 8192);
    }

    public JPushCircuit(String frame_line, int capacity) {
        headmap = new HashMap<>();
    ...
    public JPushCircuit(byte[] frameRaw) {
        this(frameRaw, 8192);
    }

    public JPushCircuit(byte[] frameRaw, int capacity) {
...
//		b.writeBytes(crcf);
     ...
     * @param other
     */
    public void fillFrom(JPushCircuit other) {
     ...
     * @param by
     */
    public void coverFrom(JPushCircuit by) {
