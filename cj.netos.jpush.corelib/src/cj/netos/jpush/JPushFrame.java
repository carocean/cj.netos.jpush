 ...
 * @author carocean
 */
public class JPushFrame implements IPrinter, IDisposable {
    ...
    public JPushFrame(String frame_line) {
     ...
     * @param frame_line
     */
    public JPushFrame(String frame_line, int capacity) {
        this(frame_line, Unpooled.buffer(capacity));
    }

    public JPushFrame(String frame_line, ByteBuf contentData) {
    ...
    public JPushFrame(byte[] frameRaw) {
        this(frameRaw, 8192);
    }
     ...
     * @param frameRaw
     */
    public JPushFrame(byte[] frameRaw, int capacity) {
        this(frameRaw, Unpooled.buffer(capacity));
    }

    public JPushFrame(byte[] frameRaw, ByteBuf contentData) {
        headmap = new HashMap<String, String>(8);
        parametermap = new HashMap<String, String>(4);
        content = new DefaultFrameContent(contentData);
    ...
    public void add(JPushFrame frame) {
    ...
    public JPushFrame copy() {
        JPushFrame f = new JPushFrame();
